	...
	private static void AddListener(JButton b, int value, int re, int i, int j) {
		...
		b.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//ImageIcon lei = new ImageIcon(System.getProperty("user.dir") + "/src/lei.png");
				//ImageIcon redFlag = new ImageIcon(System.getProperty("user.dir") + "/src/redFlag.png");
				//ImageIcon unsure = new ImageIcon(System.getProperty("user.dir") + "/src/unsure.png");
